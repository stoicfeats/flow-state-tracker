        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full items-stretch pb-6">
            ...
            <div className="lg:col-span-5 flex flex-col gap-6 h-full min-h-0">
                <motion.div
                    ...
                    className="bg-white/40 dark:bg-white/5 rounded-[3rem] p-4 border border-zinc-200 dark:border-white/5 backdrop-blur-xl shadow-2xl dark:shadow-[0_0_50px_rgba(0,0,0,0.3)] flex flex-col items-center justify-center flex-1 min-h-0 relative overflow-hidden"
                >
                    <Timer
                        {...timerProps}
                        scale={0.8}
